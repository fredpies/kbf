...
// Pobierz dane o usługach na podstawie filtra
$services = $pages->find(get_filter($input, 'service', false));

// Paginacja listy usług
    ...
    <div class="container">
        <div class="row pt-5 pb-2">
            ...
            <div class="col-12 col-lg-4 ">
                <h5 class="font-weight-800 mb-0 text-center text-lg-left">USŁUGI W KBF</h5>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center justify-content-lg-start px-0 mb-0">
                        ...
                        <li class="breadcrumb-item text-uppercase text-nowrap active" aria-current="page">Lista usług
                        </li>
                    </ol>
                </nav>
                ...
                <div class="col-lg-4">
                    <div class="pb-3 mb-3">
                        <div class="bg-white rounded-xl shadow-sm py-5">
                            ...
                            <form autocomplete="off" method="get" role="form" action="<?= $pages->get("template=services")->url; ?>">
                            ...
                            <form method="get" action="<?= $pages->get('template=services')->url; ?>" role="form">
                                <div class="flex">
                    ...
                    <div class="bg-white rounded-xl shadow-sm px-4 py-5 p-md-5">
                        ...
                        <div class="row">
                            <div class="col-12 col-xl-7">
                                <div class="font-weight-400">Liczba znalezionych usług: <span class="font-weight-600"><?php echo $services->getTotal() ?></span></div>
                                <?php

                                if ( $services->getTotal() > 0 ) echo '<div class="my-3" style="font-size: 0.75rem;"><span class="text-right"><i class="fas fa-info text-primary mr-2"></i></span>Wybierz usługę w celu wyświetlenia szczegółów.</div>';
                                else echo '<div class="my-3" style="font-size: 0.75rem;"><span class="text-right"><i class="fas fa-info text-primary mr-2"></i></span>Zmień kryteria wyszukiwania aby wyświetlić usługi.</div>';
...
<!-- Main script -->
<script src="<?php echo $urls->js ?>services.js"></script>
<script>
