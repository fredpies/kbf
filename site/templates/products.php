...
// Pobierz dane o produktach na podstawie filtra
$products = $pages->find(get_filter_selector($input, 'product'));

// Paginacja listy produktow
    ...
    <div class="container">
        <div class="row pt-5 pb-2">
            ...
            <div class="col-12 col-lg-4 ">
                <h5 class="font-weight-800 mb-0 text-center text-lg-left">PRODUKTY W KBF</h5>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center justify-content-lg-start px-0 mb-0">
                        ...
                        <li class="breadcrumb-item text-uppercase text-nowrap active" aria-current="page">Lista produktów
                        </li>
                    </ol>
                </nav>
                ...
                <div class="col-lg-4">
                    <div class="pb-3 mb-3">
                        <div class="bg-white rounded-xl shadow-sm py-5">
                            ...
                            <form autocomplete="off" method="get" role="form" action="<?= $pages->get("template=products")->url; ?>">
                        ...
                        <div class="bg-white rounded-xl shadow-sm px-4 py-5 p-md-5">
                            ...
                            <div class="row">
                                <div class="col-12 col-xl-7">
                                    <div class="font-weight-400">Liczba znalezionych produktów: <span class="font-weight-600"><?php echo $products->getTotal() ?></span></div>
                                    <?php

                                        if ( $products->getTotal() > 0 ) echo '<div class="my-3" style="font-size: 0.75rem;"><span class="text-right"><i class="fas fa-info text-primary mr-2"></i></span>Wybierz produkt w celu wyświetlenia szczegółów.</div>';
                                        else echo '<div class="my-3" style="font-size: 0.75rem;"><span class="text-right"><i class="fas fa-info text-primary mr-2"></i></span>Zmień kryteria wyszukiwania aby wyświetlić produkty.</div>';
                            ...
                            <?php
                                ...
                                foreach ($products as $product) {
                                    ...
                                    render_product_list_item($product_data);
                                }
                            ?>
...
<!-- Main script -->
<script src="<?php echo $urls->js ?>products.js"></script>
<script>
