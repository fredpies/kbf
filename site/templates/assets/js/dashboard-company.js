...
var KbfWysiwyg = /*#__PURE__*/function (_EventTarget) {
  ...
  var _super = _createSuper$2(KbfWysiwyg);
...
!function (s) {
  ...
  var _i,
    ...
    _i(t, e), t.prototype = null === e ? Object.create(e) : (s.prototype = e.prototype, new s());
  }),
  ...
  function u(t, e) {
    ...
    }, this._el = t, this._$el = $(this._el), this._$el.is("select") && (this._isSelectElement = !0), this.manageInlineDataAttributes(), "object" == _typeof(e) && (this._settings = $.extend(!0, {}, this.getSettings(), e)), this._isSelectElement && this.convertSelectToText(), this.init();
  }
  ...
  n = jQuery, n.fn[d.NAME] = function (e, s) {
...
var KbfAddressAutocomplete = /*#__PURE__*/function (_EventTarget) {
  ...
  var _super = _createSuper(KbfAddressAutocomplete);

  function KbfAddressAutocomplete(selector) {
    var _this;

    var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var lang = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'pl';

    _classCallCheck(this, KbfAddressAutocomplete);

    _this = _super.call(this);
    _this.$addressAutocomplete = $(selector); // Emituj wyjatek gdy nie podano selektora albo element nie zostal znaleziony

    if (!selector || _this.$addressAutocomplete.length === 0) throw errors.elementNotFound(selector);

    var instance = _assertThisInitialized(_this);

    _this.lang = lang;
    _this.currentAddressInfo = {}; // Aktualne dane o adresie

    _this.config = _objectSpread$1({
      minLength: 6,
      requestThrottling: 250,
      noResultsText: _this.lang === 'pl' ? 'Nie odneleziono adresu.' : '',
      ...
      formatResult: function formatResult(item) {
        ...
        return {
          ...
          html: "".concat(item.address.road.toUpperCase() + ' ' + houseNumber, ", <b>").concat(city.toUpperCase(), "</b>")
        };
      },
      events: {
        ...
        // Przygotuj wyniki
        searchPost: function searchPost(results) {
  ...
  _createClass(KbfAddressAutocomplete, [{
    key: "init",
    value: function init() {
      // Aliasy
      this.on = this.addEventListener;
    ...
    key: "emitAddressChange",
    value: function emitAddressChange() {
      var instance = this;
      setTimeout(function () {
        var $dropdownMenu = instance.$addressAutocomplete.next('.dropdown-menu');
        if ($dropdownMenu.length > 0) if ($dropdownMenu.is(':hidden')) {
          instance.emit(new CustomEvent('address-change', {
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      this.$tabToggles = $('[data-toggle="tab"]'); // Wysiwyg

      this.wysiwyg = new KbfWysiwyg('.wysiwyg');
      var htmlToInsert = this.$descriptionFieldHidden.val();
      var editor = document.getElementsByClassName('ql-editor');
      editor[0].innerHTML = htmlToInsert; //Tagify

      new KbfTagify('input.kbf-keywords'); // Preloader button

      this.preloaderButton = new KbfPreloaderButton('.submit-button', false); // Address autocomplete

      this.addressAutocomplete = new KbfAddressAutocomplete('[name="company_address"]'); // Formularz
...
//# sourceMappingURL=dashboard-company.js.map
