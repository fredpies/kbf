...
var KbfFavouriteCompanies = function KbfFavouriteCompanies() {
  _classCallCheck(this, KbfFavouriteCompanies);
  ...
  window.KbfFavouriteCompanies = function () {
    return {
      ...
      removeFromFavourites: function removeFromFavourites(e) {
        var instance = this;
        ...
        if (e.target.classList.contains('confirm-button')) {
          ...
          $modal.on('hidden.bs.modal', function () {
            $(instance.elementToFadeOut).fadeOut(400, function () {
              var favoriteIndexToDelete = instance.favouriteCompanies.findIndex(function (favourite) {
                return favourite.company_id === instance.companyToDelete;
              });
              instance.favouriteCompanies.splice(favoriteIndexToDelete, 1);
              localStorage.setItem('favourite-companies', JSON.stringify(_toConsumableArray(instance.favouriteCompanies)));
            });
          });
          $modal.modal('hide');
...
//# sourceMappingURL=dashboard-favourite-companies.js.map
