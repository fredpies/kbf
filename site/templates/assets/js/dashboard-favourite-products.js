...
var KbfFavouriteProducts = function KbfFavouriteProducts() {
  _classCallCheck(this, KbfFavouriteProducts);
        ...
        if (e.target.classList.contains('confirm-button')) {
          ...
          $modal.on('hidden.bs.modal', function () {
            $(instance.elementToFadeOut).fadeOut(400, function () {
              ...
              localStorage.setItem('favourite-products', JSON.stringify(_toConsumableArray(instance.favouriteProducts)));
            });
          });
          $modal.modal('hide');
...
//# sourceMappingURL=dashboard-favourite-products.js.map
