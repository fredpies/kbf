(function () {
  ...
  var KbfForm = /*#__PURE__*/function () {
    function KbfForm(formConfig) {
      _classCallCheck(this, KbfForm);

      var $ = window.$;
      this.formConfig = formConfig;
      this.formName = this.formConfig.formName;
      this.formElement = document.forms[this.formName]; // Sprawdz czy formularz o podanej nazwie istnieje
    ...
    _createClass(KbfForm, [{
      ...
      value: function init() {
        ...
        Array.from(this.formElement.elements).forEach(function (formElement) {
          if (formElement.name in instance.formConfig) {
            new Inputmask$1(instance.formConfig[formElement.name]).mask(formElement);
          }
        });
      }
    }, {
      ...
      value: function addListeners() {
        var instance = this;
        var $ = window.$; // Usun domyslne zachowanie formularza
  ...
  var KbfSendForm = /*#__PURE__*/function (_KbfForm) {
    ...
    var _super = _createSuper(KbfSendForm);
    ...
    function KbfSendForm() {
      ...
      var formConfig = {
        ...
        validator: {
          ...
          messages: {
            name: 'Pole z imieniem i nazwiskiem nie może być puste.' ,
            email: {
              required: 'Pole e-mail nie może być puste.' ,
              email: 'Pole e-mail posiada niewłaściwy format.' 
            },
            message: 'Treść wiadomości nie może być pusta.' 
          }
        }
      };
      return _super.call(this, formConfig, 'pl');
    }
