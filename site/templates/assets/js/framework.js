jQuery(document).ready(function() {
    ...
    /* ======================================================================
    Przenies atrybuty data-width i data-height z elementu do jego inline css
    ========================================================================= */
    $('*').each(function() {
    ...
    /* ==================================================
    Touch hover fix dla iOS
    ================================================== */
    (function(l){var i,s={touchend:function(){}};for(i in s)l.addEventListener(i,s)})(document);

    /* ==================================================
    Bootstrap: Custom Input group
    ================================================== */
    ...
    /* ==================================================
    Bootstrap: Usun tekst "x" z "close tool"
    ================================================== */
    $('.close > span').empty();

    /* ==================================================
    Ustawienia hover dla info box
    ================================================== */
    setTimeout(function(){
    ...
    // Sprawdz czy element znajduje sie w viewport
    ...
    // Animuj element gdy znajdzie się w view port, typ animacji pobierz z data-animated
    ...
    function progressBarViewport() {
        ...
        var progressCount1 = $(this).parent('.progress').prev('.progress-label').find('.progress-count'),
            ...
            if (isScrolledIntoView(this) === true) {
                ...
                // Ustaw szerokosc na podstawie aktualnej wartosci aria-valuenow
                $(this).css('width', function() {
                    return ($(this).attr('aria-valuenow')+'%');
                });

                // Animuj wartosc procentowa Count dla klasy .progress-count
    ...
    // Animuj kolowy progress gdy znajdzie sie w viewport
    ...
    // Animuj counter gdy znajdzie sie w viewport
    ...
    // Wykonuj animacje za kazdym razem gdy zmieni sie wielkosc viewport i nastepuje scrolling
    ...
    /* ==================================================
    Ustawienia dla grid item layout - .grid-item-layout
    ===================================================== */
    ...
    $('.carousel-component').each(function() {
        ...
        var carouselComponent = $(this).find('.carousel-component-inner'),
            ...
            // Ustawienia kolumn dla poszczegolnych breakpoints
    ...
    /* ===========================================================
    Synchronizacja mini galerii dla owl carousel - .gallery-sync
    ============================================================== */
    ...
    /* =========================================================
    Ustawienia na banner owl carousel - .banner-slides-wrapper
    ============================================================ */
