            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=ADMINISTRACJA, URZĘDY I FUNDACJE"?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-blush add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/overview-icon-01.svg" alt="icon" class="img-fluid">
                        </div>
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=BIURO I DOM"?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-secondary add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/counter-icon-15.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=BUDOWNICTWO I WYPOSAŻENIE"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-warning add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/counter-icon-02.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=EDUKACJA, NAUKA, KULTURA, SZTUKA"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-indigo add-animate faster" data-animated="zoomIn">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=MEDIA, KOMPUTERY, INTERNET, REKLAMA"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-success add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/service-info-box-icon-04.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=MEDYCYNA, ZDROWIE I URODA"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-primary add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/overview-icon-03.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=MOTORYZACJA, TRANSPORT, KOMUNIKACJA"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-carrot add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/counter-icon-06.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=PRACA"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-sky add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/counter-icon-13.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-cente mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=PRAWO, FINANSE, TŁUMACZENIA"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-orchid add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/service-icon-25.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=PRZEMYSŁ, AUTOMATYKA"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-rose add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/counter-icon-04.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=TURYSTYKA, SPORT, REKREACJA, HOTELE"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-indigo add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/overview-icon-02.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=WŁÓKIENNICTWO, ODZIEŻ, OBUWIE"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-success add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/hero-banner-3-icon-02.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="icon-info-5 text-center mt-2 mb-2">
                    <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=ŻYWNOŚĆ, ROLNICTWO, EKOLOGIA, LEŚNICTWO, OGRODNICTWO"; ?>">
                        <div class="icon-element d-flex align-items-center justify-content-center mb-2 bg-scarlet add-animate faster" data-animated="zoomIn">
                            <img src="<?php echo $urls->svg ?>upload/hero-banner-3-icon-03.svg" alt="icon" class="img-fluid">
                        </div>
                        <div class="icon-info-text text-center">
                            <h6 class="font-weight-700 mb-3">ŻYWNOŚĆ, ROLNICTWO, EKOLOGIA, LEŚNICTWO, OGRODNICTWO</h6>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="col-12 d-lg-none d-xl-flex col-xl-6 order-xl-2 px-md-5">
                    <div class="align-self-end w-100 px-5">
                        <div class="px-md-5 mt-md-4 img-container">
                            ...
                            <img src="<?php echo $urls->images ?>phone-map-hand.png" alt="image" class="img-fluid add-animate slide-animate" data-animated="slideInLeft">
                            <a href="<?php echo $pages->get("template=map")->url; ?>" class="btn btn-round btn-lg btn-primary mb-2 on-img-button">Wyszukaj na mapie</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=ADMINISTRACJA, URZĘDY I FUNDACJE"?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-blush add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/overview-icon-01.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=BIURO I DOM"?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-secondary add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/counter-icon-15.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">BIURO I DOM</h6>
                            </div>
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=BUDOWNICTWO I WYPOSAŻENIE"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-warning add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/counter-icon-02.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">BUDOWNICTWO I WYPOSAŻENIE</h6>
                            </div>
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=EDUKACJA, NAUKA, KULTURA, SZTUKA"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-indigo add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/pen-info.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">EDUKACJA, NAUKA, KULTURA, SZTUKA</h6>
                            </div>
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=MEDIA, KOMPUTERY, INTERNET, REKLAMA"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-success add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/service-info-box-icon-04.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">MEDIA, KOMPUTERY, INTERNET I REKLAMA</h6>
                            </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=MEDYCYNA, ZDROWIE I URODA"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-primary add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/overview-icon-03.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">MEDYCYNA, ZDROWIE I URODA</h6>
                            </div>
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=MOTORYZACJA, TRANSPORT, KOMUNIKACJA"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-carrot add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/counter-icon-06.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">MOTORYZACJA, TRANSPORT, KOMUNIKACJA</h6>
                            </div>
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=PRACA"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-sky add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/counter-icon-13.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">PRACA</h6>
                            </div>
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=PRAWO, FINANSE, TŁUMACZENIA"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-orchid add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/service-icon-25.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">PRAWO, FINANSE, TŁUMACZENIA</h6>
                            </div>
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=PRZEMYSŁ, AUTOMATYKA"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-rose add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/counter-icon-04.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">PRZEMYSŁ, AUTOMATYKA</h6>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=TURYSTYKA, SPORT, REKREACJA, HOTELE"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-indigo add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/overview-icon-02.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">TURYSTYKA, SPORT, REKREACJA, HOTELE</h6>
                            </div>
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=WŁÓKIENNICTWO, ODZIEŻ, OBUWIE"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-success add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/hero-banner-3-icon-02.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">WŁÓKIENNICTWO, ODZIEŻ, OBUWIE</h6>
                            </div>
                ...
                <div class="col">
                    <div class="icon-info-5 text-center pb-4 mb-5">
                        <a class="icon-info-link" href="<?php echo $pages->get("template=companies")->url."?industry=ŻYWNOŚĆ, ROLNICTWO, EKOLOGIA, LEŚNICTWO, OGRODNICTWO"; ?>">
                            <div class="icon-element d-flex align-items-center justify-content-center mb-4 bg-scarlet add-animate faster" data-animated="zoomIn">
                                <img src="<?php echo $urls->svg ?>upload/hero-banner-3-icon-03.svg" alt="icon" class="img-fluid" data-width="48px" data-height="48px">
                            </div>
                            <div class="icon-info-text px-4 pt-3">
                                <h6 class="font-weight-700 mb-3">ŻYWNOŚĆ, ROLNICTWO, EKOLOGIA, LEŚNICTWO, OGRODNICTWO</h6>
                            </div>
    ...
    <div class="section bg-light py-5">
        <div class="container">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="<?php echo $pages->get("template=companies")->url; ?>" class="text-reset">
                        <div class="bg-white text-center rounded-xl shadow-sm p-4">
                            <div class="py-4 mt-2">
                                <img src="<?php echo $urls->svg ?>upload/directory-cate-icon-02.svg" alt="icon" class="add-animate faster" data-animated="zoomIn" data-width="64px" data-height="64px">
                            </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="<?php echo $pages->get("template=products")->url; ?>" class="text-reset add-animate" data-animated="rotateIn">
                        <div class="bg-white text-center rounded-xl shadow-sm p-4">
                            <div class="py-4 mt-2">
                                <img src="<?php echo $urls->svg ?>upload/directory-benefits-icon-02.svg" alt="icon" class="add-animate faster" data-animated="zoomIn" data-width="64px" data-height="64px">
                            </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="<?php echo $pages->get("template=services")->url; ?>" class="text-reset">
                        <div class="bg-white text-center rounded-xl shadow-sm p-4">
                            <div class="py-4 mt-2">
                                <img src="<?php echo $urls->svg ?>upload/directory-cate-icon-04.svg" alt="icon" class="add-animate faster" data-animated="zoomIn" data-width="64px" data-height="64px">
                            </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="<?php echo $pages->get("template=jobs")->url; ?>" class="text-reset">
                        <div class="bg-white text-center rounded-xl shadow-sm p-4">
                            <div class="py-4 mt-2">
                                <img src="<?php echo $urls->svg ?>upload/directory-cate-icon-08.svg" alt="icon" class="add-animate faster" data-animated="zoomIn" data-width="64px" data-height="64px">
                            </div>
