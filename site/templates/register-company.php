...
// Adres
$company_address_field = new FormFieldAddressAutocomplete(true);
...
$company_zip_field->required = "required";
...
$form_step_3->addField($company_fields->get("company_nip"));
...
$form_step_3->addMarkup(render_info_message('Wpisz słowa kluczowe umożliwiające pozycjonowanie strony firmy przez wyszukiwarki internetowe, np. Google.<br><a class="about-keywords d-inline-block text-hover-primary mt-2">Zobacz poprawnie wpisane słowa kluczowe.</a>'), true);
...
// Rejestruj kroki
$stepper->registerStep("Dane adresowe", "Podaj numer regon w celu pobrania informacji o swojej firmie.", $form_step_1->render());
...
$stepper->registerStep("Pozostałe informacje", "Podaj dane kontaktowe oraz słowa kluczowe umożliwiające pozycjonowanie firmy w internecie.", $form_step_3->render());
