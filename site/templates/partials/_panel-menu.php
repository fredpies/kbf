        ...
        <div class="bg-white rounded-xl shadow-sm pt-5 pb-3">
            ...
            <div id="sidebarMenu" class="d-lg-block collapse">
                ...
                <ul class="list-group list-group-flush py-0">
                    ...
                    <a href="<?php echo $pages->get(1)->url ?>panel/uslugi" class="<?php if ($page->title === 'Usługi') echo 'active' ?> list-group-item list-group-item-action d-flex justify-content-between align-items-center px-4 px-md-5 px-lg-4 px-xl-5">
                    ...
                    <a href="<?php echo $pages->get(1)->url ?>panel/oferty-pracy" class="<?php if ($page->title === 'Oferty Pracy' || $page->title === 'Dodaj ofertę pracy' || $page->title === 'Edytuj ofertę pracy' ) echo 'active' ?> list-group-item list-group-item-action d-flex justify-content-between align-items-center px-4 px-md-5 px-lg-4 px-xl-5">
                ...
                <ul class="list-group list-group-flush py-0">
                    ...
                    <a href="<?= $pages->get('template=dashboard-change-password')->url ?>" class="<?php if ($page->title === 'Zmiana hasła') echo 'active' ?> list-group-item list-group-item-action d-flex justify-content-between align-items-center px-4 px-md-5 px-lg-4 px-xl-5">
                        <div class="d-flex align-items-center">
